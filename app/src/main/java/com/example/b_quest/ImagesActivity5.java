...
public class ImagesActivity5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hero_images5);


        questImageView2 = findViewById(R.id.image_view_hero5);
    ...
    private void showImage() {
        ...
        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            ...
            public void onFailure(@NonNull Exception exception) {
                ...
                Toast.makeText(ImagesActivity5.this, "NO IMAGE", Toast.LENGTH_SHORT).show();
            }
        });
    }

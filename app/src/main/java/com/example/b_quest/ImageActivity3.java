...
public class ImageActivity3 extends AppCompatActivity {
    ...
    private ImageView questImageView3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hero_images3);


        questImageView3 = findViewById(R.id.image_view_hero3);
        ...
        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            ...
            public void onSuccess(Uri uri) {
                ...
                if (Picasso.get().load(url) != null) {
                    Picasso.get().load(url).into(questImageView3);
                }
            ...
            public void onFailure(@NonNull Exception exception) {
                ...
                Toast.makeText(ImageActivity3.this, "NO IMAGE", Toast.LENGTH_SHORT).show();
            }
        });
    }

...
public class ImagesActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hero_images2);


        questImageView2 = findViewById(R.id.image_view_hero2);
    ...
    private void showImage() {
        ...
        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            ...
            public void onFailure(@NonNull Exception exception) {
                ...
                Toast.makeText(ImagesActivity2.this, "NO IMAGE", Toast.LENGTH_SHORT).show();
            }
        });
    }

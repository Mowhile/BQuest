...
public class ImagesActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hero_images4);


        questImageView2 = findViewById(R.id.image_view_hero4);
    ...
    private void showImage() {
        ...
        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            ...
            public void onFailure(@NonNull Exception exception) {
                ...
                Toast.makeText(ImagesActivity4.this, "NO IMAGE", Toast.LENGTH_SHORT).show();
            }
        });
    }
